...
//     // Clean output
//     const full = review.toObject();
//     const { history, ...cleanReview } = full;

//     return res.json({
//       message: "Final review updated",
//       review: cleanReview,
//       history
//     });
...
//     if (!review) {
//       return res.json({ review: null, history: [] });
//     }

//     const { history, ...cleanReview } = review;
